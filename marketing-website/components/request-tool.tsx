export default function RequestTool() {
  return (
    <section>
      <div className="max-w-6xl mx-auto px-4 sm:px-6" id="request-tool">
            ...
            <div className="relative flex flex-col lg:flex-row justify-between items-center">
              ...
              <div className="text-center lg:text-left lg:max-w-xl">
                <h3 className="h3 text-white mb-2">
                  Have an Idea for a Software Tool?
                </h3>
                <p className="text-gray-300 text-lg mb-6">
                  We're always looking to build useful tools that can help you
                  and the community. If you have a problem that we can solve you
                  can submit your idea here. We might actually help you build
                  it!
                </p>
                ...
                >
                  ...
                  <div className="flex justify-center lg:justify-start mt-4">
                    <button
                      type="submit"
                      className="btn text-white bg-blue-600 hover:bg-blue-700 shadow px-6 py-3 rounded-sm"
                    >
                      Submit Idea
                    </button>
                  </div>
                  <p className="text-sm text-gray-400 mt-3 text-center lg:text-left">
                    We respect your privacy. Your email and idea will not be
                    shared.
                  </p>
                </form>
              </div>
